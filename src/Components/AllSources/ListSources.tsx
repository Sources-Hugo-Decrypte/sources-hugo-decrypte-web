                                ...
                                <tbody className="sm:contents">
                                    {
                                        sourcesData.map(source => (
                                            <tr className="grid grid-cols-5 mb-4 sm:text-justify sm:contents group" key={source.name + '-row'}>
                                                ...
                                                <td className="col-span-4 pt-3 pl-2 sm:whitespace-nowrap text-ellipsis font-bold text-lg sm:text-base sm:col-span-1 sm:p-0 sm:py-1 sm:font-normal sm:group-odd:bg-gray-100">{source.name}</td>
